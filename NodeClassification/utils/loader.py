...
def load_data_10(g_data = 'amazon-com'):
    if g_data == 'weekday':
        startdate = datetime.date(1980, 1, 1)
        enddate = datetime.date(2020, 1, 1)
        delta = datetime.timedelta(days=1)
    ...
    for i in range(10):
        ...
        idx_train_10.append(idx_train)
        idx_val_10.append(idx_val)
        idx_test_10.append(idx_test)
        print(idx_train)

    return A, X, y, idx_train_10, idx_val_10, idx_test_10