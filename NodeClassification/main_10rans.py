...
def get_args():
    ...
    parser.add_argument('--model', type=str, default='exact', help='Models to use')
    ...
    ### Etc
    parser.add_argument('--num_head_attentions', type=int, default=4, help='Number of head attentions')
...
def main():
    ...
    """
    dataset = args.data
    A, X, y, idx_train_list, idx_val_list, idx_test_list = load_data_10(dataset)
