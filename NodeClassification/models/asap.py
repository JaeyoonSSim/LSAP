...
class ASAP3(nn.Module):
    def __init__(self, adj_dim, in_dim, hid_dim, out_dim, dropout):
        super(ASAP3, self).__init__()
        self.dropout = dropout
...
class ASAP4(nn.Module):
    def __init__(self, adj_dim, in_dim, hid_dim, out_dim, dropout):
        super(ASAP4, self).__init__()
        self.dropout = dropout
